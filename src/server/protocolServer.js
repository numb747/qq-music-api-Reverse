...
const routes = {
  ...
  'POST /api/playback/resolve': (b) => client.resolvePlaybackUrl({ songmid: b.songmid, songtype: b.songtype, filename: b.filename, mediaMid: b.mediaMid, quality: b.quality, guid: b.guid }),
  'POST /api/song/playable': (b) => client.resolvePlayableBySong({ songmid: b.songmid, songId: b.songId, preferQualities: b.preferQualities }),
